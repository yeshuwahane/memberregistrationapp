...
android {
    namespace = "com.yeshuwahane.memberregistrationapp"
    compileSdk = 35

    defaultConfig {
        applicationId = "com.yeshuwahane.memberregistrationapp"
        minSdk = 24
        targetSdk = 35
        versionCode = 1
        versionName = "1.0"
...
// Ensure that KSP generates code in the correct directory
kotlin {
    sourceSets {
